...
######################################################################################################################### instr.(H) ####### addr.(H)
      ...
      ori     $2, $2, 0x1166      # low halfword of the student no (last 8 digitals)                                       # 1                4
...
dispsortedstuno:
      lw      $3, 0x104($0)       #  load the sorted student no.                                                           # 26               98
      j       displayseg7label                                                                                             # 27               9C
dispstuno:
      lw      $3, 0x100($0)       #  load the orginal student no.                                                          # 28               A0
displayseg7label: 
